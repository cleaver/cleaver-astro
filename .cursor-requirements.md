...
1. **Storage**: All images will be stored in the `src/images/` directory in their original format (JPEG), organized by year/month to match content structure. This allows Astro to properly handle them as assets.
