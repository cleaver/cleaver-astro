...
1. **Storage**: All images will be stored in the `public/images/` directory in their original format (JPEG), organized by year/month to match content structure
...
- Original high-resolution images are preserved
